...
export default function Home() {
  ...
  return (
    <div className="relative">
      <FlexStructure classes={" md:h-[80vh] md:w-[150%]"}>
        <div className="bg-primary w-11/12 justify-center  self-center  rounded-2xl relative mt-2 md:mx-6 md:mt-12" ref={leftSide}>
          ...
          <h1 className="font-sans text-4xl text-center bg-black text-white absolute  top-1/2 inset-x-2 rounded-xl md:bottom-12 md:text-5xl md:py-4 md:top-auto">
            frasco.com.ar
          </h1>
        </div>
